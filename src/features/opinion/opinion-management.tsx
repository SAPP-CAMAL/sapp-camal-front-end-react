...
import { TableOpinion } from "./components/table-opinion";
    ...
    <div>
      <section className="mb-4 flex flex-col sm:flex-row sm:justify-between gap-2">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            Administra las opiniones/dictámenes veterinarios usados en la
      ...
      <Card className="mb-4">
        <CardHeader>
          ...
          <CardDescription>
            Filtre las opiniones por nombre o estado
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          },
          {
            ...
            cell: ({ row }) => (
              <div className="flex justify-center gap-x-2">
                <UpdateOpinion opinion={row.original} />
                <DeleteOpinion opinion={row.original} />
              </div>
            ),
          },
        ]}
