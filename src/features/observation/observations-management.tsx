...
import { MessageSquareWarningIcon, SearchIcon } from "lucide-react";
import { TableObservations } from "./table-observations";
import { useQuery } from "@tanstack/react-query";
import { parseAsInteger, parseAsString, useQueryStates } from "nuqs";
import { useDebouncedCallback } from "use-debounce";
import { getObservationsPaginatedService } from "./server/db/observation-admin.service";
...
const OBSERVATION_TAG = "observations-admin";
...
export function ObservationsManagement() {
  ...
  const query = useQuery({
    queryKey: [OBSERVATION_TAG, searchParams],
    queryFn: () =>
      getObservationsPaginatedService({
    ...
    <div>
      ...
      <Card className="mb-4">
        <CardHeader>
          ...
          <CardDescription>
            Filtre las observaciones por nombre o estado
          </CardDescription>
        </CardHeader>
        <CardContent>
