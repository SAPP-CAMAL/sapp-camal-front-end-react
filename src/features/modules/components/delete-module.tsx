...
import { deleteModulePermanentlyService } from "../server/db/modules.service";
import { Module } from "../domain/module.domain";

export function DeleteModule({ module }: { module: Module }) {
  const queryClient = useQueryClient();

  const handleDelete = async () => {
    try {
      await deleteModulePermanentlyService(module.id);
