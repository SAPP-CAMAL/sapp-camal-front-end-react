...
import {
    CreateReportCodeBody,
    ResponseReportCodesPaginated,
    ResponseReportCodesService,
    SearchParamsReportCodes,
} from "@/features/report-codes/domain/report-codes.domain";
...
export function getReportCodesPaginatedService(searchParams: SearchParamsReportCodes): Promise<ResponseReportCodesPaginated> {
    return http.get("v1/1.0.0/report-codes/list", { searchParams }).json()
}
