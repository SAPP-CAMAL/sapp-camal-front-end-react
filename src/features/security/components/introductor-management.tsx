...
import { UpdateRol } from "@/features/roles/components/update-rol";
      ...
      <TableIntroducers
        columns={[
          ...
          },
          {
            ...
            cell: ({ row }) => (
              <Badge
                variant={row.original.status ? "tertiary" : "outline"}
