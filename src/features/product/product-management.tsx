...
import { ManageProductAnatomicalLocations } from "./components/manage-product-anatomical-locations";
    ...
    <div>
      <section className="mb-4 flex flex-col sm:flex-row sm:justify-between gap-2">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            Administra el catálogo de productos/órganos inspeccionables y sus
      ...
      <Card className="mb-4">
        <CardHeader>
          ...
          <CardDescription>
            Filtre los productos por descripción, código o estado
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <TableProduct
        columns={[
          ...
          },
          {
            ...
            header: () => "Tipo",
            cell: ({ row }) => (
              <Badge variant={row.original.productType ? "default" : "outline"}>
                {row.original.productType ? "Producto" : "Sub-producto"}
              </Badge>
            ),
          },
          {
            id: "parent",
            header: () => "Producto Padre",
            cell: ({ row }) =>
              row.original.parentId
                ? productsById.get(row.original.parentId)?.description ?? "-"
                : "-",
          },
          {
            accessorKey: "status",
          ...
          },
          {
            ...
            cell: ({ row }) => (
              <div className="flex justify-center gap-x-2">
                ...
                <ManageProductAnatomicalLocations product={row.original} />
