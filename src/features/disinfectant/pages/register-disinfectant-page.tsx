...
import { DailyDisinfectionLogTable, RegisterDisinfectantDataForm, RegisterDisinfectantPageHeader } from '@/features/disinfectant/components';
...
export const RegisterDisinfectantPage = () => {
	return (
		<DisinfectantProvider>
			...
			<section className='overflow-hidden rounded-lg border p-4 bg-white'>
				{/* Form */}
