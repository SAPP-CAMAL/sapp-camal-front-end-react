    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleRegisterDisinfectantData)}>
        ...
        <div className="px-2 py-4">
            ...
            <SearchShippersInput
              ...
              fullName={{
                ...
                onChange: (text: string) =>
                  handleSearchFields("fullName", text),
              }}
              identification={{
          ...
          {showShippersList && (
            <ShipperListCard
              onSelectShipper={handleSetShipper}
              shippers={shippers}
            />
          )}
          ...
          {showCreateShippingFromSomeFields && (
            <BasicResultsCard
              className="text-sm"
              title="No se encontraron transportistas con el nombre, identificación o placa proporcionados."
            />
          )}

          {form.watch("showShipperAlert") && (
            <p className="text-destructive text-sm mt-4">
              Por favor seleccione un transportista
            </p>
          )}
        </div>
        ...
        <div className="px-2 py-4">
          <FormField
            ...
            rules={{
              required: {
                value: true,
                message: "Las especie a transportar es requerido",
              },
            }}
            render={({ field }) => (
              <FormItem>
        ...
        <div className="px-2 py-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <FormField
            ...
            rules={{
              required: {
                value: true,
                message: "El nombre del desinfectante es requerido",
              },
            }}
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            ...
            name="dosage"
            rules={{
              required: { value: true, message: "La dosis es requerido" },
            }}
            render={({ field }) => (
              <FormItem>
        ...
        <div className="px-2 py-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <FormField
            ...
            rules={{
              required: {
                value: true,
                message: "La hora de aplicación de ingreso es requerido",
              },
            }}
            render={({ field }) => (
              <FormItem>
            ...
            rules={{
              ...
              validate: {
                isAfterAdmission: (value) => {
                  const admissionTime = form.getValues(
                    "admissionApplicationTime"
                  );
