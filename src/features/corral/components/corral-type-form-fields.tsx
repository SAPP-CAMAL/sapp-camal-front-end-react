...
export function NewCorralTypeFields({ showStatus = false }: { showStatus?: boolean }) {
  const form = useFormContext<NewCorralTypeForm>();
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex gap-2 items-center">
            <HouseIcon /> Información Básica
          </CardTitle>
          <CardDescription>Define el código y descripción del tipo de corral.</CardDescription>
        </CardHeader>
