...
import { getReportTemplatesPaginatedService } from "./server/db/report-template-admin.service";
...
const REPORT_TEMPLATES_TAG = "report-templates-admin";
...
export function ReportTemplatesManagement() {
    ...
    const query = useQuery({
        queryKey: [REPORT_TEMPLATES_TAG, searchParams],
        queryFn: () =>
            getReportTemplatesPaginatedService({
        ...
        <div>
            ...
            <Card className="mb-4">
                <CardHeader>
                    ...
                    <CardDescription>
                        Filtre las plantillas de reporte por nombre o estado
                    </CardDescription>
                </CardHeader>
                <CardContent>
