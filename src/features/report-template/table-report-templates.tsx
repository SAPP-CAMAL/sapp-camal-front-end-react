...
export function TableReportTemplates<TData, TValue>({
    columns,
    data,
    isLoading,
    ...
    return (
        <div className="bg-white border rounded-lg overflow-hidden">
            <div className="py-4 px-4 flex flex-col border-b">
                <Label className="font-semibold text-lg lg:text-base">Plantillas de Reporte</Label>
            </div>
                                    ...
                                    <CardContent className="p-4 space-y-2">
                                        ...
                                        {cellsById.type && (
                                            <div className="text-sm text-gray-500">
                                                {flexRender(cellsById.type.column.columnDef.cell, cellsById.type.getContext())}
                                            </div>
                                        )}
                                        {cellsById.actions && (
