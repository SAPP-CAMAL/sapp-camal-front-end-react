...
export function TableUnitMeasures<TData, TValue>({
  columns,
  data,
  isLoading,
  ...
  return (
    <div className="bg-white border rounded-lg overflow-hidden">
      <div className="py-4 px-4 flex flex-col border-b">
        <Label className="font-semibold text-lg lg:text-base">Unidades de Medida</Label>
      </div>
              ...
              return (
                <Card key={row.id} className="overflow-hidden border-gray-200 py-0 gap-0">
                  <CardContent className="p-4 space-y-2">
                    ...
                    {cellsById.symbol && (
                      <div className="text-sm text-gray-500">
                        {flexRender(cellsById.symbol.column.columnDef.cell, cellsById.symbol.getContext())}
                      </div>
                    )}
                    {cellsById.actions && (
