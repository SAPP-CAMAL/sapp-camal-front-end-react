...
export function NewOrderStatusFields({ showStatus = false }: { showStatus?: boolean }) {
    const form = useFormContext<NewOrderStatusForm>();
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex gap-2 items-center">
                        <ListChecksIcon /> Estado de Pedido
                    </CardTitle>
                    <CardDescription>Define el nombre, código y descripción del estado.</CardDescription>
                </CardHeader>
