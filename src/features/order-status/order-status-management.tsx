...
import { getOrderStatusPaginatedService } from "./server/db/order-status.service";
...
export function OrderStatusManagement() {
    ...
    const query = useQuery({
        queryKey: ["order-status-admin", searchParams],
        queryFn: () =>
            getOrderStatusPaginatedService({
        ...
        <div>
            ...
            <Card className="mb-4">
                <CardHeader>
                    ...
                    <CardDescription>
                        Filtre los estados de pedido por nombre o estado
                    </CardDescription>
                </CardHeader>
                <CardContent>
