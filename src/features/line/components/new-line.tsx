...
import { createLineService } from "../server/db/line-admin.service";
import { useEffect, useState } from "react";

export type NewLineForm = {
    name: string;
    idSpecie: number;
    description: string;
    status: string;
...
const defaultValues: NewLineForm = {
    name: "",
    idSpecie: 0,
    description: "",
    status: "true",
...
export function NewLine() {
    ...
    const form = useForm<NewLineForm>({ defaultValues });
        ...
        <Dialog open={open} onOpenChange={(open) => setOpen(open)}>
            ...
            <DialogContent className="max-h-screen overflow-y-auto w-[95vw] sm:max-w-[60vw]">
                <DialogHeader>
                    ...
                    <DialogDescription>Registra una nueva línea de faenamiento.</DialogDescription>
                </DialogHeader>
                <Form {...form}>
