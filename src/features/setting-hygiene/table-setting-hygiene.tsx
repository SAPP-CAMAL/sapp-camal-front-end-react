...
export function TableSettingHygiene<TData, TValue>({
  columns,
  data,
  meta,
  isLoading,
  ...
  return (
    <div className="bg-white border rounded-lg overflow-hidden">
      <div className="py-4 px-4 flex flex-col border-b">
        <Label className="font-semibold text-lg lg:text-base">Configuración de Higiene por Equipo</Label>
      </div>
                  ...
                  <CardContent className="p-4 space-y-2">
                    <div className="flex items-start justify-between gap-2">
                      <div className="font-semibold text-sm min-w-0 truncate">
                        {cellsById.equipment &&
                          flexRender(cellsById.equipment.column.columnDef.cell, cellsById.equipment.getContext())}
                      </div>
                      {cellsById.status && (
                    ...
                    {cellsById.equipmentType && (
                      <div className="text-sm text-gray-500">
                        {flexRender(cellsById.equipmentType.column.columnDef.cell, cellsById.equipmentType.getContext())}
                      </div>
                    )}
                    {cellsById.actions && (
