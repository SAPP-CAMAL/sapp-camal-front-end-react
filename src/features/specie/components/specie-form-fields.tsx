...
export function NewSpecieFields({ showStatus = false }: { showStatus?: boolean }) {
    const form = useFormContext<NewSpecieForm>();
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex gap-2 items-center">
                        <PawPrintIcon /> Especie
                    </CardTitle>
                    <CardDescription>Define el nombre, código y descripción de la especie.</CardDescription>
                </CardHeader>
