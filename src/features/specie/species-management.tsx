...
import { getSpeciesPaginatedService } from "./server/db/specie-admin.service";
...
export function SpeciesManagement() {
    ...
    const query = useQuery({
        queryKey: ["species-admin", searchParams],
        queryFn: () =>
            getSpeciesPaginatedService({
        ...
        <div>
            ...
            <Card className="mb-4">
                <CardHeader>
                    ...
                    <CardDescription>
                        Filtre las especies por nombre o estado
                    </CardDescription>
                </CardHeader>
                <CardContent>
