...
export function NewDisinfectantCatalogFields({ showStatus = false }: { showStatus?: boolean }) {
    const form = useFormContext<NewDisinfectantCatalogForm>();
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex gap-2 items-center">
                        <SprayCanIcon /> Desinfectante
                    </CardTitle>
                    <CardDescription>Define el nombre y descripción del desinfectante.</CardDescription>
                </CardHeader>
