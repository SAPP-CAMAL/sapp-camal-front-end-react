								...
								<div className='flex gap-2'>
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												<FormControl>
													<div className='flex items-center gap-2 flex-1 text-pink-700 font-semibold text-lg'>
														H
														<Input
															className='bg-pink-100 rounded-lg border border-pink-300 text-pink-700 font-bold text-xl h-12'
															type='number'
															placeholder='0'
															min={0}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												<FormControl>
													<div className='flex items-center gap-2 flex-1 text-blue-700 font-semibold text-lg'>
														M
														<Input
															className='border-blue-200 bg-gradient-to-br from-blue-50 via-white to-blue-50 text-blue-700 font-bold text-xl h-12'
															type='number'
															placeholder='0'
															min={0}
															onWheel={e => e.currentTarget.blur()} // prevent number input change on wheel
						...
						{isBovineSpecie && (
							<div className='space-y-2'>
								<FormField
									...
									rules={{
										validate: value => {
											const rings = value === null || value === undefined ? 0 : +value;
