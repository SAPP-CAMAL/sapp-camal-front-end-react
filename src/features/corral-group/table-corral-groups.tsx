...
export function TableCorralGroups<TData, TValue>({
  columns,
  data,
  isLoading,
  ...
  return (
    <div className="bg-white border rounded-lg overflow-hidden">
      <div className="py-4 px-4 flex flex-col border-b">
        <Label className="font-semibold text-lg lg:text-base">Grupos de Corrales</Label>
      </div>
                  ...
                  <CardContent className="p-4 space-y-2">
                    ...
                    {cellsById.line && (
                      <div className="text-sm text-gray-500">
                        {flexRender(cellsById.line.column.columnDef.cell, cellsById.line.getContext())}
                      </div>
                    )}
                    {cellsById.finishType && (
                      <div className="text-sm text-gray-500">
                        {flexRender(cellsById.finishType.column.columnDef.cell, cellsById.finishType.getContext())}
                      </div>
                    )}
                    {cellsById.actions && (
